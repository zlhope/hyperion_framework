...
public class TestData {
    ...
    public static int DistanceToDestination = 300;
    ...
    public static String auto = "keySetMapColorAuto";
    public static String day = "keySetMapColorDay";
    public static String night = "keySetMapColorNight";
    public static String homePref = "KeyHomeAndWorkSetting";
    public static String showMyPlace = "keyShowMyPlacesBubble";
    public static String HOME = "keySetHomeAddress";
    public static String CUSTOM = "KeySetWorkAddress";
    public static String work = "keySelectLabelWork";
    public static String school = "keySelectLabelSchool";
    public static String daycare = "keySelectLabelDaycare";
    public static String gym = "keySelectLabelGym";
    public static String custom = "keySelectLabelCustomized";
    ...
    public static String fastest = "keyRouteStyleFastest";
    ...
    public static String eco = "keyRouteStyleECO";
    ...
    public static String mapMode = "keyRenderingMode";
    ...
    public static String poiOnMap = "keyPOIOnMap";
